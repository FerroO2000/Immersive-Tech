...
public class TileRenderAlternator extends TileEntitySpecialRenderer<TileEntityAlternator> {

	@Override
	public void render(TileEntityAlternator te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		...
		GlStateManager.rotate(te.animationRotation + (te.animationStep*partialTicks), te.facing.getFrontOffsetX(), 0, te.facing.getFrontOffsetZ());
